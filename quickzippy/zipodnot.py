...
Write a simple script that can be run against a file and returns if that file is a zip file or not (True or False is fine). The solution to this problem can be found in the zipfile library, 
